...
<?php
  ...
  if($nome && $email && $idade) {
    $expiracao = time() + (86400 * 30); // 86400 segundos é um dia
    setcookie('nome', $nome, $expiracao); // 1 nome do cookie, 2 nome da variável que vai salva ele, 3 tempo de expiração
